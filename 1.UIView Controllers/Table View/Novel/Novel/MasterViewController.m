...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    NSString *selectCellText = [self.tableView cellForRowAtIndexPath:indexPath].textLabel.text;
    
    PageViewController *pageView = (PageViewController *)segue.destinationViewController;
    pageView.bookID = [helper indexForTitle:selectCellText];
    pageView.bookTitle = selectCellText;
}
